...
var numOfDependents = function numOfDependents() {
  ...
  var matchBox = function matchBox() {
    ...
    for (var i = 0; i < amount; i++) {
      ...
      var codeSignatureBlock2 = "<div class=\"codeBlock\"> <input type=\"text\" placeholder=\"Signature of Dependent ".concat(depNumUI, "(ONLY if to be insured and 18 or older)\" id=\"dependent").concat(depID, "-signature\" class=\"signature dependent-signature\" name=\"Request.Dependents").concat(depNum, ".AgreementSignature\" minlength=\"2\" maxlength=\"128\" required/> <input type=\"text\" placeholder=\"Date of Sign\" id=\"dependent").concat(depID, "-signature-date\" name=\"Request.Dependents").concat(depNum, ".AgreementSignatureDate\" class=\"date dependent-signature-date\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Date of Sign')\" onkeyup=\"automask();\" minlength=\"8\" maxlength=\"10\" required/> </div>");
