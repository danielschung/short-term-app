...
var numOfDependents = function numOfDependents() {
  ...
  var matchBox = function matchBox() {
    ...
    for (var i = 0; i < amount; i++) {
      ...
      var codeSignatureBlock = "<div class=\"codeBlock\"> <input type=\"text\" placeholder=\"Signature of Dependent ".concat(_depNumUI, "(ONLY if to be insured and 18 years or older)\" id=\"dependent-agreement-signature\" class=\"signature\" name=\"Request.Dependents").concat(_depNum, ".AgreementSignature\" minlength=\"2\" maxlength=\"128\"/> <input type=\"text\" placeholder=\"Date of Sign\" id=\"dependent-agreement-signature-date\" name=\"Request.Dependents").concat(_depNum, ".AgreementSignatureDate\" class=\"date\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Date of Sign')\" onkeyup=\"automask();\" minlength=\"8\" maxlength=\"10\"/> </div>");
