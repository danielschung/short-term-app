...
var numOfDependents = function numOfDependents() {
  ...
  var matchBox = function matchBox() {
    ...
    for (var i = 0; i < amount; i++) {
      ...
      var codeSignatureBlock = "<div class=\"codeBlock\"> <input type=\"text\" placeholder=\"Signature of Dependent (ONLY if to be insured and 18 years or older)\" required id=\"dependent-agreement-signature\" name=\"Request.Dependents".concat(depNum, ".AgreementSignature\" minlenght=\"2\" maxlength=\"128\"/> <input type=\"text\" placeholder=\"Date of Sign\" required id=\"dependent-agreement-signature-date\" name=\"Request.Dependents").concat(depNum, ".AgreementSignatureDate\" class=\"date\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Date of Sign')\" onkeyup=\"automask();\" minlength=\"8\" maxlength=\"10\"/> </div>");
      var codeSignatureBlock2 = "<div class=\"codeBlock2\"> <input type=\"text\" placeholder=\"Signature of Dependent\" required id=\"dependent-authorization-signature\" name=\"Request.Dependents".concat(depNum, ".AuthorizationSignature\" minlength=\"2\" maxlength=\"128\"> <input type=\"text\" placeholder=\"Date of Sign\" required id=\"dependent-authorization-signature-date\" name=\"Request.Dependents").concat(depNum, ".AuthorizationSignatureDate\" class=\"date\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Date of Sign')\" onkeyup=\"automask();\" minlength=\"8\" maxlength=\"10\"> </div>");
