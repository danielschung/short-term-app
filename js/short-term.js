...
var addSpouseSignature = function addSpouseSignature() {
  var codeBlock = "<div class=\"codeBlock\"> <input type=\"text\" placeholder=\"Signature of Dependent ".concat(depNumUI, "(ONLY if to be insured and 18 years or older)\" id=\"dependent-agreement-signature\" class=\"signature\" name=\"Request.Dependents").concat(depNum, ".AgreementSignature\" minlength=\"2\" maxlength=\"128\" required/> <input type=\"text\" placeholder=\"Date of Sign\" id=\"dependent-agreement-signature-date\" name=\"Request.Dependents").concat(depNum, ".AgreementSignatureDate\" class=\"date\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Date of Sign')\" onkeyup=\"automask();\" minlength=\"8\" maxlength=\"10\" required/> </div>");
...
var numOfDependents = function numOfDependents() {
  ...
  var matchBox = function matchBox() {
    ...
    for (var i = 0; i < amount; i++) {
      ...
      var _depNum = "[".concat(amountArray[i], "]");

      var _depNumUI = "".concat(amountArray[i] + 1, " ");

      var depID = "".concat(amountArray[i]);
      var codeBlock = "<div class=\"codeBlock\"> <p class=\"header\">Dependent ".concat(_depNumUI, "Personal Information</p><input type=\"text\" placeholder=\"First Name\" required id=\"dependent").concat(depID, "-first-name\" class=\"dependent-names\" name=\"Request.Dependents").concat(_depNum, ".FirstName\" minlength=\"2\" maxlength=\"128\"> <input type=\"text\" placeholder=\"MI\" class=\" optional dependent-MI\" id=\"dependent").concat(depID, "-MI\" name=\"Request.Dependents").concat(_depNum, ".MiddleName\" maxlength=\"1\"> <input type=\"text\" placeholder=\"Last Name\" required id=\"dependent").concat(depID, "-last-name\" class=\"dependent-names\" name=\"Request.Dependents").concat(_depNum, ".LastName\" minlength=\"2\" maxlength=\"128\"> <input type=\"text\" placeholder=\"SSN\" required id=\"dependent").concat(depID, "-SSN\" class=\"SSN dependent-SSN\" name=\"Request.Dependents").concat(_depNum, ".Ssn\" onkeyup=\"automask();\" minlength=\"9\" maxlength=\"9\"> <input type=\"text\" placeholder=\"Birthday\" required id=\"dependent").concat(depID, "-birthday\" class=\"date dependent-birthday\" name=\"Request.Dependents").concat(_depNum, ".Birthdate\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Birthday')\" onkeyup=\"automask();calculateAge();checkAgeSignature();\" minlength=\"8\" maxlength=\"10\"> <select required id=\"dependent").concat(depID, "-gender\" value=\"\" class=\"purple-format dependent-gender\" name=\"Request.Dependents").concat(_depNum, ".Sex\"> <option value=\"\" disabled selected class=\"placeholder\">Gender</option> <option value=\"male\">Male</option> <option value=\"female\">Female</option> </select> <p class=\"header\">Health Information</p><input type=\"hidden\" placeholder=\"Age\" required id=\"dependent").concat(depID, "-age\" class=\"age dependent-age\" name=\"Request.Dependents").concat(_depNum, ".Age\" onkeyup=\"automask();\" minlength=\"1\" maxlength=\"3\"> <input type=\"text\" placeholder=\"Height\" required id=\"dependent").concat(depID, "-height\" class=\"height dependent-height\" name=\"Request.Dependents").concat(_depNum, ".Height\" onfocus=\"(this.placeholder='0&lsquo; 00&ldquo;')\" onblur=\"(this.placeholder='Height')\" onkeyup=\"automask();\" minlength=\"2\" maxlength=\"6\"> <input type=\"text\" placeholder=\"Weight\" required id=\"dependent").concat(depID, "-weight\" class=\"weight dependent-weight\" name=\"Request.Dependents").concat(_depNum, ".Weight\" onkeyup=\"automask();\" minlength=\"2\" maxlength=\"4\"> <input type=\"text\" placeholder=\"Primary Care Physician (First Name)\" required id=\"dependent").concat(depID, "-pcp-first-name\" class=\"dependent-pcp-first-name\" name=\"Request.Dependents").concat(_depNum, ".PcpFirstName\" minlength=\"2\" maxlength=\"128\"> <input type=\"text\" placeholder=\"Primary Care Physician (Last Name)\" required id=\"dependent").concat(depID, "-pcp-last-name\" class=\"dependent-pcp-last-name\" name=\"Request.Dependents").concat(_depNum, ".PcpLastName\" minlength=\"2\" maxlength=\"128\"> <div class=\"question\"> <p>Are you an established patient?</p><select required id=\"dependent").concat(depID, "-question-1\" value=\"\" class=\"purple-format question\" name=\"Request.Dependents").concat(_depNum, ".IsEstablishedPatient\"> <option value=\"\" disabled selected class=\"placeholder\">Choose</option> <option value=\"true\">Yes</option> <option value=\"false\">No</option> </select> <div class=\"clear\"></div></div><div class=\"question\"> <p>Have you been declined for insurance due to health reasons within the past 18 months?</p><select required id=\"dependent").concat(depID, "-question-2\" value=\"\" class=\"purple-format question\" name=\"Request.Dependents").concat(_depNum, ".HasBeenDeclined\"> <option value=\"\" disabled selected class=\"placeholder\">Choose</option> <option value=\"true\">Yes</option> <option value=\"false\">No</option> </select> <div class=\"clear\"></div></div><div class=\"question\"> <p>Do you have hospital, major medical, group health, government or medical insurance coverage that will overlap during the duration of this coverage?</p><select required id=\"dependent").concat(depID, "-question-3\" value=\"\" class=\"purple-format question\" name=\"Request.Dependents").concat(_depNum, ".HasInsuranceOverlap\"> <option value=\"\" disabled selected class=\"placeholder\">Choose</option> <option value=\"true\">Yes</option> <option value=\"false\">No</option> </select> <div class=\"clear\"></div></div><div class=\"question\"> <p>If you are female, are you now pregnant, or if you are male, are you an expectant parent?</p><select required id=\"dependent").concat(depID, "-question-4\" value=\"\" class=\"purple-format question\" name=\"Request.Dependents").concat(_depNum, ".IsExpectantParent\"> <option value=\"\" disabled selected class=\"placeholder\">Choose</option> <option value=\"true\">Yes</option> <option value=\"false\">No</option> </select> <div class=\"clear\"></div></div><div class=\"question\"> <p>Do you weigh more than 300 pounds if male or more than 250 pounds if female?</p><select required id=\"dependent").concat(depID, "-question-5\" value=\"\" class=\"purple-format question\" name=\"Request.Dependents").concat(_depNum, ".IsOverweight\"> <option value=\"\" disabled selected class=\"placeholder\">Choose</option> <option value=\"true\">Yes</option> <option value=\"false\">No</option> </select> <div class=\"clear\"></div></div><div class=\"question\"> <p>In the past five years, have you taken medication for or been advised, consulted, tested, diagnosed, treated or hospitalized or recommended for treatment by a physician for any of the following: heart or circulatory system disorder, including heart attack or stroke; insulin-dependent diabetes; cancer or tumors; disorder of the blood, including hemophilia or leukemia; kidney or liver disorder; mental or nervous conditions or disorders; alcoholism or alcohol abuse; drug abuse, addiction or dependency; organ transplant; emphysema; Crohn\u2019s disease, ulcerative colitis or hepatitis?</p><select required id=\"dependent").concat(depID, "-question-6\" value=\"\" class=\"purple-format question\" name=\"Request.Dependents").concat(_depNum, ".HasSeriousHealthCondition\"> <option value=\"\" disabled selected class=\"placeholder\">Choose</option> <option value=\"true\">Yes</option> <option value=\"false\">No</option> </select> <div class=\"clear\"></div></div><div class=\"question\"> <p>Have you ever been diagnosed or treated by a physician for acquired immune deficiency syndrome (AIDS) or AIDS-related complex (ARC), or have you in the past five years tested positive for HIV virus or other immune disorders?</p><select required id=\"dependent").concat(depID, "-question-7\" value=\"\" class=\"purple-format question\" name=\"Request.Dependents").concat(_depNum, ".HasImmuneDisorder\"> <option value=\"\" disabled selected class=\"placeholder\">Choose</option> <option value=\"true\">Yes</option> <option value=\"false\">No</option> </select> <div class=\"clear\"></div></div></div>");
      var codeSignatureBlock = "<div class=\"codeBlock\"> <input type=\"text\" placeholder=\"Signature of Dependent ".concat(_depNumUI, "(ONLY if to be insured and 18 years or older)\" id=\"dependent").concat(depID, "-signature\" class=\"signature dependent-signature\" name=\"Request.Dependents").concat(_depNum, ".AgreementSignature\" minlength=\"2\" maxlength=\"128\" required/> <input type=\"text\" placeholder=\"Date of Sign\" id=\"dependent").concat(depID, "-signature-date\" name=\"Request.Dependents").concat(_depNum, ".AgreementSignatureDate\" class=\"date dependent-signature-date\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Date of Sign')\" onkeyup=\"automask();\" minlength=\"8\" maxlength=\"10\" required/> </div>");
      var codeSignatureBlock2 = "<div class=\"codeBlock2\"> <input type=\"text\" placeholder=\"Signature of Dependent ".concat(_depNumUI, "\" required id=\"dependent-authorization-signature\" name=\"Request.Dependents").concat(_depNum, ".AuthorizationSignature\" minlength=\"2\" maxlength=\"128\"> <input type=\"text\" placeholder=\"Date of Sign\" required id=\"dependent-authorization-signature-date\" name=\"Request.Dependents").concat(_depNum, ".AuthorizationSignatureDate\" class=\"date\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Date of Sign')\" onkeyup=\"automask();\" minlength=\"8\" maxlength=\"10\"> </div>");
...
var validate = function validate() {
  ...
  var inputs = container.find('input:required, select:required').toArray();
  console.log(inputs); //validate checkboxes and text inputs (else)
