...
var numOfDependents = function numOfDependents() {
  ...
  var matchBox = function matchBox() {
    ...
    for (var i = 0; i < amount; i++) {
      ...
      var codeSignatureBlock2 = "<div class=\"codeBlock2\"> <input type=\"text\" placeholder=\"Signature of Dependent ".concat(depNumUI, "\" required id=\"dependent").concat(depID, "-authorization-signature\" name=\"Request.Dependents").concat(depNum, ".AuthorizationSignature\" minlength=\"2\" maxlength=\"128\"> <input type=\"text\" placeholder=\"Date of Sign\" required id=\"dependent").concat(depID, "-authorization-signature-date\" name=\"Request.Dependents").concat(depNum, ".AuthorizationSignatureDate\" class=\"date\" onfocus=\"(this.placeholder='MM/DD/YYYY')\" onblur=\"(this.placeholder='Date of Sign')\" onkeyup=\"automask();\" minlength=\"8\" maxlength=\"10\"> </div>");
