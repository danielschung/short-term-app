...
const numOfDependents = () => {
	...
	const matchBox = () => {
		...
		for (let i = 0; i < amount; i++) {
			...
			let codeSignatureBlock2 = `<div class="codeBlock2"> <input type="text" placeholder="Signature of Dependent ${depNumUI}" required id="dependent${depID}-authorization-signature" name="Request.Dependents${depNum}.AuthorizationSignature" minlength="2" maxlength="128"> <input type="text" placeholder="Date of Sign" required id="dependent${depID}-authorization-signature-date" name="Request.Dependents${depNum}.AuthorizationSignatureDate" class="date" onfocus="(this.placeholder='MM/DD/YYYY')" onblur="(this.placeholder='Date of Sign')" onkeyup="automask();" minlength="8" maxlength="10"> </div>`;
